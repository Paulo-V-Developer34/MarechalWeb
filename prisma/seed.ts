...
const initialNoticias: Prisma.NoticiaCreateInput[] = [
    {
        ...
        intro: "Essa notícia é a mais incrível de todas as notícias que você já viu na vida",
        content: "Essa notícia conta a história de como a notícia mais incrível do mundo foi criada, ela é realmente muito incrível",
        Autor: {
            connectOrCreate: {
                where: {
                    nome: "Diretor da Escola"
