    ...
    return (
        <section id="agenda" className="w-full flex flex-col items-center">
            ...
            <div className="w-11/12 sm:w-10/12 md:w-3/4 lg:w-2/4 m-6 flex flex-col items-center">
                <p className="w-5/6 mb-8 text-[2vw]">A sessão(não sei se está certo) "Agenda" permite aos alunos fazerem o agendamento da utilização de espaços e áreas disponibilizadas pela escola com o intuito da realização de estudos, pesquisas e projetos.</p>
                <Link href='./Agenda/Agenda' className="flex flex-row-reverse w-full h-full">
